...
# ACDS 15.1 185 linux 2016.03.24.12:58:29
# ----------------------------------------
...
# # End of template
# ----------------------------------------
# If ddc_fir3 is one of several IP cores in your
...
alias com {
  ...
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/ddc_fir3_rtl.vhd"                               
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/ddc_fir3_ast.vhd"                               
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/ddc_fir3.vhd"                                   
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/ddc_fir3_tb.vhd"                                
}
