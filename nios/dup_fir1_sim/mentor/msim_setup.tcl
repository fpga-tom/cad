...
# # End of template
# ----------------------------------------
# If dup_fir1 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 15.1 185 linux 2016.03.27.11:21:00
...
alias com {
  ...
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dup_fir1_rtl.vhd"                               
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dup_fir1_ast.vhd"                               
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dup_fir1.vhd"                                   
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dup_fir1_tb.vhd"                                
}
