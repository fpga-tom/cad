...
function  output = dup_fir1_mlab(stimulation, bank)
 coef_matrix_in= [57,22,26,31,36,41,46,52,57,63,69,74,80,86,91,97,102,106,110,114,118,121,123,125,126,127,127,126,125,123,121,118,114,110,106,102,97,91,86,80,74,69,63,57,52,46,41,36,31,26,22,57];
 INTER_FACTOR = 20;
 DECI_FACTOR  = 1;
 MSB_RM  = 6;
 MSB_TYPE  = 1;
