...
# # End of template
# ----------------------------------------
# If dup_fir3 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 15.1 185 linux 2016.03.26.12:33:35
...
alias com {
  ...
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dup_fir3_rtl.vhd"                               
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dup_fir3_ast.vhd"                               
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dup_fir3.vhd"                                   
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dup_fir3_tb.vhd"                                
}
