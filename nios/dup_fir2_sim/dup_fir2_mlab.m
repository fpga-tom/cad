...
function  output = dup_fir2_mlab(stimulation, bank)
 coef_matrix_in= [37,22,27,34,41,49,56,65,73,81,89,96,103,109,115,119,123,125,127,127,125,123,119,115,109,103,96,89,81,73,65,56,49,41,34,27,22,37];
 INTER_FACTOR = 25;
 DECI_FACTOR  = 1;
 MSB_RM  = 0;
 MSB_TYPE  = 0;
