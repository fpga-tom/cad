...
# # End of template
# ----------------------------------------
# If dup_fir2 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 15.1 185 linux 2016.03.26.12:48:03
...
alias com {
  ...
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dup_fir2_rtl.vhd"                               
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dup_fir2_ast.vhd"                               
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dup_fir2.vhd"                                   
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dup_fir2_tb.vhd"                                
}
