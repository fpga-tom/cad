...
# setting SOPC_SYSID_BASE_ADDRESS is 0x200110d0
SOPC_SYSID_FLAG += --sidp=0x200110d0
ELF_PATCH_FLAG  += --sidp 0x200110d0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1451766015
SOPC_SYSID_FLAG += --timestamp=1451766015
ELF_PATCH_FLAG  += --timestamp 1451766015
