...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../C5G.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x20011090
SOPC_SYSID_FLAG += --sidp=0x20011090
ELF_PATCH_FLAG  += --sidp 0x20011090

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1451678664
SOPC_SYSID_FLAG += --timestamp=1451678664
ELF_PATCH_FLAG  += --timestamp 1451678664
