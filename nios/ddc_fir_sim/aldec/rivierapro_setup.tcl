...
# ACDS 15.1 185 linux 2016.01.03.18:48:56
# ----------------------------------------
...
# # End of template
# ----------------------------------------
# If ddc_fir is one of several IP cores in your
...
alias com {
  ...
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/ddc_fir_rtl.vhd"                                
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/ddc_fir_ast.vhd"                                
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/ddc_fir.vhd"                                    
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/ddc_fir_tb.vhd"                                 
}
