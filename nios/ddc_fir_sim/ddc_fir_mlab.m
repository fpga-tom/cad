...
function  output = ddc_fir_mlab(stimulation, bank)
 coef_matrix_in= [9,10,12,16,21,27,34,42,51,60,69,79,88,97,105,112,117,122,125,127,127,125,122,117,112,105,97,88,79,69,60,51,42,34,27,21,16,12,10,9];
 INTER_FACTOR  = 1;
 DECI_FACTOR  =  20;
 MSB_RM  = 0;
 MSB_TYPE  = 0;
