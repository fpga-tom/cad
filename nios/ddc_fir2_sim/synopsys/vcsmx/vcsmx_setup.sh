...
# ACDS 15.1 185 linux 2016.03.24.18:42:05
...
# # End of template
# ----------------------------------------
# If ddc_fir2 is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ddc_fir2_rtl.vhd"                               
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ddc_fir2_ast.vhd"                               
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ddc_fir2.vhd"                                   
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ddc_fir2_tb.vhd"                                
fi
