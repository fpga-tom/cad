...
# ACDS 15.1 185 linux 2016.01.06.16:09:15
# ----------------------------------------
...
alias com {
  ...
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/ddc_fir2_rtl.vhd"                               
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/ddc_fir2_ast.vhd"                               
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/ddc_fir2.vhd"                                   
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/ddc_fir2_tb.vhd"                                
}
