...
# ACDS 15.1 185 linux 2016.03.24.18:41:22
# ----------------------------------------
...
# # End of template
# ----------------------------------------
# If ddc_fir1 is one of several IP cores in your
...
alias com {
  ...
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/ddc_fir1_rtl.vhd"                               
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/ddc_fir1_ast.vhd"                               
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/ddc_fir1.vhd"                                   
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/ddc_fir1_tb.vhd"                                
}
