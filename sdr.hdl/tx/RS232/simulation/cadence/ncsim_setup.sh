...
# ACDS 15.1 185 win32 2015.12.05.16:49:19
...
# # End of template
# ----------------------------------------
# If RS232 is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/RS232_rs232_0.v"                   -work rs232_0 -cdslib ./cds_libs/rs232_0.cds.lib
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/RS232.v"                                                                                      
fi
