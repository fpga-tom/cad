...
# ACDS 15.1 185 linux 2015.12.24.20:05:05
# ----------------------------------------
...
# # End of template
# ----------------------------------------
# If channelizer_fft is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "channelizer_fft"
}
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/channelizer_fft_fft_ii_0_opt_twr2.hex ./
  file copy -force $QSYS_SIMDIR/submodules/channelizer_fft_fft_ii_0_opt_twi1.hex ./
  file copy -force $QSYS_SIMDIR/submodules/channelizer_fft_fft_ii_0_opt_twr1.hex ./
  file copy -force $QSYS_SIMDIR/submodules/channelizer_fft_fft_ii_0_opt_twi2.hex ./
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/channelizer_fft_fft_ii_0.vo" -work fft_ii_0
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/channelizer_fft.vhd"                                  
}
