...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/submodules/channelizer_fft_fft_ii_0.vo" -work fft_ii_0
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/channelizer_fft.vhd"                                  
fi
