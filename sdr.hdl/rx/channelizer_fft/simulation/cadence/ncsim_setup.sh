...
TOP_LEVEL_NAME="channelizer_fft"
QSYS_SIMDIR="./../"
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/channelizer_fft_fft_ii_0_opt_twr2.hex ./
  cp -f $QSYS_SIMDIR/submodules/channelizer_fft_fft_ii_0_opt_twi1.hex ./
  cp -f $QSYS_SIMDIR/submodules/channelizer_fft_fft_ii_0_opt_twr1.hex ./
  cp -f $QSYS_SIMDIR/submodules/channelizer_fft_fft_ii_0_opt_twi2.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/channelizer_fft_fft_ii_0.vo" -work fft_ii_0 -cdslib ./cds_libs/fft_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/channelizer_fft.vhd"                                                                      
fi
