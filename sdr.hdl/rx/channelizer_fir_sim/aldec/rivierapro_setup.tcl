...
# ACDS 15.1 185 linux 2015.12.26.16:17:12
# ----------------------------------------
...
# # End of template
# ----------------------------------------
# If channelizer_fir is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "channelizer_fir"
}
...
alias com {
  ...
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/channelizer_fir_rtl.vhd"                        
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/channelizer_fir_ast.vhd"                        
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/channelizer_fir.vhd"                            
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/channelizer_fir_tb.vhd"                         
}
