...
TOP_LEVEL_NAME="channelizer_fir"
QSYS_SIMDIR="./../../"
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/channelizer_fir_rtl.vhd"                        
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/channelizer_fir_ast.vhd"                        
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/channelizer_fir.vhd"                            
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/channelizer_fir_tb.vhd"                         
fi
