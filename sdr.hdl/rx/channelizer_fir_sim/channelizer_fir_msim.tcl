...
transcript on
write transcript channelizer_fir_transcript

# START MEGAWIZARD INSERT VARIABLES
set top_entity channelizer_fir
set timing_resolution "1ps"
set core_version 15.1
set device_family CYCLONEV
set quartus_rootdir /home/tomas/altera_lite/15.1/quartus/
...
if {[string match $flow "rtl"] } {
    ...
    if {[file exists channelizer_fir.vo]} {vlog -work work channelizer_fir.vo} else {
    	vcom -93 -work work channelizer_fir.vho
	}
