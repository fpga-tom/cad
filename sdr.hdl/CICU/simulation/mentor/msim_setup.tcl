...
# # End of template
# ----------------------------------------
# If CICU is one of several IP cores in your
...
# ----------------------------------------
# ACDS 15.1 185 win32 2015.11.29.05:46:15
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/CICU_cic_ii_0.vo" -work cic_ii_0
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/CICU.vhd"                                  
}
