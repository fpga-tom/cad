...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/CICU_cic_ii_0.vo" -work cic_ii_0 -cdslib ./cds_libs/cic_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/CICU.vhd"                                                                      
fi
