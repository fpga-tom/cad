...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/NCO_nco_ii_0.vo" -work nco_ii_0 -cdslib ./cds_libs/nco_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/NCO.vhd"                                                                      
fi
