...
# ACDS 15.1 185 win32 2015.11.28.20:58:02
# ----------------------------------------
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/NCO_nco_ii_0.vo" -work nco_ii_0
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/NCO.vhd"                                  
}
